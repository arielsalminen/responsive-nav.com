/*! responsive-nav.js v1.09 by @arielsalminen, http://responsive-nav.com, MIT license */
...
init:function(){},open:function(){},close:function(){}};for(c in b)this.options[c]=b[c];n(u,this.options.jsClass);this.wrapperEl=a.replace("#","");if(h.getElementById(this.wrapperEl))this.wrapper=h.getElementById(this.wrapperEl);else throw Error("The nav element you are trying to select doesn't exist");c=this.wrapper;for(var e=this.wrapper.firstChild;null!==e&&1!==e.nodeType;)e=e.nextSibling;c.inner=e;f=this.options;d=this.wrapper;this._init(this)};s.prototype={destroy:function(){this._removeStyles();
p(d,"closed");p(d,"opened");d.removeAttribute("style");d.removeAttribute("aria-hidden");q=d=null;m(g,"load",this,!1);m(g,"resize",this,!1);m(e,"mousedown",this,!1);m(e,"touchstart",this,!1);m(e,"keyup",this,!1);m(e,"click",this,!1);f.customToggle?e.removeAttribute("aria-hidden"):e.parentNode.removeChild(e)},toggle:function(){r?(p(d,"opened"),n(d,"closed"),j(d,{"aria-hidden":"true"}),f.animate?setTimeout(function(){d.style.position="absolute"},f.transition+10):d.style.position="absolute",r=!1,f.close()):
(p(d,"closed"),n(d,"opened"),d.style.position=f.openPos,j(d,{"aria-hidden":"false"}),r=!0,f.open())},handleEvent:function(a){a=a||g.event;switch(a.type){case "mousedown":this._onmousedown(a);break;case "touchstart":this._ontouchstart(a);break;case "keyup":this._onkeyup(a);break;case "click":this._onclick(a);break;case "load":this._transitions(a);this._resize(a);break;case "resize":this._resize(a)}},_init:function(){n(d,"closed");this._createToggle();l(g,"load",this,!1);l(g,"resize",this,!1);l(e,"mousedown",
this,!1);l(e,"touchstart",this,!1);l(e,"keyup",this,!1);l(e,"click",this,!1)},_createStyles:function(){k.parentNode||v.appendChild(k)},_removeStyles:function(){k.parentNode&&k.parentNode.removeChild(k)},_createToggle:function(){if(f.customToggle){var a=f.customToggle.replace("#","");if(h.getElementById(a))e=h.getElementById(a);else throw Error("The custom nav toggle you are trying to select doesn't exist");}else a=h.createElement("a"),a.innerHTML=f.label,j(a,{href:"#",id:"nav-toggle",tabindex:f.tabIndex}),
